...
export const buttonList: object = [
    ...
    { selector:"fraction", render: "&frac12;", mathValue: "\\frac{}{}" },
    { selector:"sqrt", render: "&radic;", mathValue: "\\sqrt[]{}" },
    { selector:"log", render: "log", mathValue: "\\log\\left(\\right)" },
