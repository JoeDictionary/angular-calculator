...
var grammar = {
    ...
    {"name": "function", "symbols": ["function$string$1", "expression", {"literal":"}"}], "postprocess": ([a, b, c]) => "Math.sqrt(" + b + ")"},
    ...
    {"name": "function", "symbols": ["function$string$2", "expression", "function$string$3"], "postprocess": ([a, b, c]) => "Math.log(" + b + ")"},
    ...
    {"name": "function", "symbols": ["function$string$4", "expression", "function$string$5", "expression", "function$string$6"], "postprocess": ([a, b, c, d, e]) => "Math.log(" + d + ") / Math.log(" + b + ")"},
